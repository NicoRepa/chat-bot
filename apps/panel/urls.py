...
urlpatterns = [
    ...
    path('menu/nivel4/crear/', views.MenuLevel4CreateView.as_view(), name='menu_level4_create'),
    path('menu/nivel4/<uuid:item_id>/editar/', views.MenuLevel4UpdateView.as_view(), name='menu_level4_update'),
    path('menu/nivel4/<uuid:item_id>/eliminar/', views.MenuLevel4DeleteView.as_view(), name='menu_level4_delete'),
